                ...
                <div className="container">
                    <div className="flex max-lg:flex-col max-lg:items-start gap-y-10 pb-10">
                        <div className="lg:w-1/4">
                            <div className="footer-company-infor flex flex-col justify-between gap-5">
                                <Image src="/images/Tecnofactblanco.png" alt="TecnoFact Logo" width={149} height={40} className="w-[149px]" />
                        ...
                        <div className="lg:w-1/2">
                            <div className="footer-navigate flex items-center justify-center gap-20">
                                <div className="footer-nav-item">
                                    <div className="item-heading text-button-sm text-white">Enlaces Rápidos</div>
                                    <ul className="list-nav mt-1">
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/about">Nosotros</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/service/cfdi-app">Servicios</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/pages/pricing">Planes</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/contact">Contacto</Link></li>
                                    </ul>
                                </div>
                                <div className="footer-nav-item max-sm:hidden">
                                    <div className="item-heading text-button-sm text-white">Servicios</div>
                                    <ul className="list-nav mt-1">
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/service/cfdi-app">CFDI App TecnoFact</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/service/panel-cfdi">Panel CFDI</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/service/monitor-cfdi">Monitor CFDI</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/service/timbraexpress">TimbraExpress</Link></li>
                                    </ul>
                                </div>
                                <div className="footer-nav-item">
                                    <div className="item-heading text-button-sm text-white">Soporte</div>
                                    <ul className="list-nav mt-1">
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/pages/faqs">Preguntas Frecuentes</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="https://demo.tecnofact.mx/login" target="_blank">Demo en Línea</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="https://app.tecnofact.mx/register" target="_blank">Registrarse</Link></li>
                                        <li className="mt-3"><Link className="caption1 has-line-before line-white text-surface hover-underline" href="/contact">Centro de Ayuda</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="lg:w-1/4">
                            <div className="company-contact">
                                <div className="heading text-button-sm text-white">Contacto</div>
                                <div className="mt-3 flex items-center">
                                    ...
                                    <div className="text ml-16">
                                        <div className="caption2 text-surface">Soporte Técnico</div>
                                        <div className="fw-700 text-white mt-1">(669) 454-0439</div>
                                    </div>
                                </div>
                                <div className="locate mt-3 flex items-center">
                                    <Icon.MapPin weight="light" className="text-surface" />
                                    <div className="caption1 text-surface ml-2">Av. de la Marina #6115, Local 13, Marina Mazatlán, C.P. 82013, Mazatlán, Sinaloa</div>
                                </div>
                                <form className="send-block mt-5 flex items-center h-[46px] rounded-lg overflow-hidden">
                                    <input className="caption1 text-secondary h-full w-full pr-4 pl-3" type="email" placeholder="contacto@tecnofact.mx" required />
                    ...
                    <div className="footer-bottom flex items-center justify-between pt-3 pb-3">
                        <div className="left-block flex items-center">
                            <div className="copy-right text-surface caption1">2024 SERVICIOS DE FACTURACIÓN ELECTRONICA Y SOFTWARE DEL PACIFICO S. de R.L. de C.V. Todos los derechos reservados.</div>
                        </div>
                        <div className="nav-link flex items-center gap-2.5">
                            <a className="text-surface caption1 hover-underline" href="https://tecnofact.mx/privacy-policy-2/" target="_blank">Términos y Condiciones</a>
                            <span className="text-surface caption1">|</span>
                            <a className="text-surface caption1 hover-underline" href="https://tecnofact.mx/privacy-policy-2/" target="_blank">Política de Privacidad</a>
                        </div>
                    </div>
                </div>
            </div>

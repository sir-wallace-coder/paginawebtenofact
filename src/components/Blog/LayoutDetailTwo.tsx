          ...
          <div className="w-full lg:w-2/3">
            <div className="blog-paragraph">
              <div className="paragraph-heading">
                <div className="bg-img"><Image width={4000} height={4000} className="w-full rounded-2xl" src={data?.img || "/images/blog/930x593.png"} alt="img" /></div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-7 mt-8">
                {data?.listImg ? data?.listImg.map(item => (
                  ...
                  <>
                    <div className="w-full"> <Image width={4000} height={4000} className="w-full rounded-xl" src="/images/blog/930x593.png" alt="img" /></div>
                    <div className="w-full"> <Image width={4000} height={4000} className="w-full rounded-xl" src="/images/blog/930x593.png" alt="img" /></div>
                  </>
                )}
              </div>
